Game.Entity = function(properties) {
  ...
  for (var i = 0; i < mixins.length; i++) {
    // Copy over all properties from each mixin as long as its not
    // the names or the init property. We also make sure not to override
    ...
    // Add the name of this mixin to our attached attached Mixins
